...
function processLoadedImage(path, image) {
    ...
    // Generate texture reference to the webGL context
    ...
    // Tells WebGL done manipulation data a the mGL.TEXTURE_2D target.
...
function activate(textureName) {
    ...
    // gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN__FILTER, gl.NEAREST);
}
