...
TextureRenderable.prototype._indexToWCPosition = function (
    returnWCPos, i, j
) {
    let x = i * this.mXform.getWidth() / this.mElmHeightPixels;
...
TextureRenderable.prototype._wcPositionToIndex = function (
    returnIndex, wcPos
) {
    ...
    // recall that xForm.getPosition() retrun center, yet
    // Texture origin is at lower-left corner!
    returnIndex[0] += this.mElmWidthPixels / 2;
    returnIndex[1] += this.mElmWidthPixels / 2;
